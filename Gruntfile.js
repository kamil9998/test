module.exports = function (grunt) {
    grunt.initConfig({
        ...
        sprite: {
            all: {
                src: 'img/sprites/*.png',            // folder z naszymi ikonami, każda zmiana w nim będzie podować wygenerowanie sprita
                dest: 'img/spritesheet.png',       // wynikowy plik z ikonami
                destCss: 'scss/_icons.scss',            // plik gdzie wygeneruje nam mixin bądź css
